...
{
public:
  DriveController(ros::NodeHandle& nh_priv, std::string& name) : Controller(),
                                                                           nh_priv_(nh_priv),
                                                                           name_(name),
  ...
  bool init()
  {
    enable_controller_subscriber_ = nh_priv_.subscribe("enable", 10, &DriveController::enableCB, this);
    disable_controller_subscriber_ = nh_priv_.subscribe("disable", 10, &DriveController::disableCB, this);
    bumper_event_subscriber_ = nh_priv_.subscribe("events/bumper", 10, &DriveController::bumperEventCB, this);
    cliff_event_subscriber_ = nh_priv_.subscribe("events/cliff", 10, &DriveController::cliffEventCB, this);
    wheel_drop_event_subscriber_ = nh_priv_.subscribe("events/wheel_drop", 10,
                                                      &DriveController::wheelDropEventCB, this);
...
void DriveController::cliffEventCB(const kobuki_msgs::CliffEventConstPtr msg)
{
...
void DriveController::wheelDropEventCB(const kobuki_msgs::WheelDropEventConstPtr msg)
{
