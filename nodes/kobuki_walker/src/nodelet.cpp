...
#include "kobuki_walker/walker_controller.hpp"
...
{
public:
  WalkerControllerNodelet(): shutdown_requested_(false){};
  ...
  virtual void onInit()
  {
    ...
    controller_.reset(new WalkerController(nh_priv, name_));
    ...
    if (controller_->init())
    {
      ...
      update_thread_.start(&WalkerControllerNodelet::update, *this);
    }
    else
    {
...
private:
  ...
  boost::shared_ptr<WalkerController> controller_;
